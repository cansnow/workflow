...
<script>
//import jexcelStyle from 'jspreadsheet-ce/dist/jspreadsheet.css'; // eslint-disable-line no-unused-vars
//import jExcel from 'jspreadsheet-ce'; // eslint-disable-line no-unused-vars
import jquery from "../myExcel-master/js/jquery-2.0.3.js"
import excel from "../myExcel-master/js/excel.js"
import windowFun from "../myExcel-master/js/windowFun.js"
import "../myExcel-master/css/excel.css";
import "../myExcel-master/css/main.css";
export default {
	name: 'ExcelEditor',
	data() {
		return {
